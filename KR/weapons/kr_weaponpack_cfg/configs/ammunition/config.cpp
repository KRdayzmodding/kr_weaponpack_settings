...
class CfgMagazines
{
	...
	class kr_Ammo_762x25_HP: Ammunition_Base
	{
		scope = 2;
		displayName = "$STR_kr_weapons_ammo_762x25_HP";
		descriptionShort = "$STR_kr_weapons_ammo_762x25_HP_dsc";
		model = "\KR\weapons\kr_weaponpack\ammunition\looseRounds\762x25_HP_LooseRounds.p3d";
		iconCartridge = 1;
		weight = 12;
		count = 60;
		ammo = "Bullet_762x25_HP";
		class kr_description
		{
			kr_tier = 2;
			kr_caliber = "7.62x25";
	...
	class kr_Ammo_545x39_HP: Ammunition_Base
	{
		scope = 2;
		displayName = "$STR_kr_weapons_ammo_545x39_HP";
		descriptionShort = "$STR_kr_weapons_ammo_545x39_HP_dsc";
		model = "\KR\weapons\kr_weaponpack\ammunition\looseRounds\545x39_HP_LooseRounds.p3d";
		iconCartridge = 2;
		weight = 11;
		count = 60;
		ammo = "Bullet_545x39_HP";
		class kr_description
		{
			kr_tier = 3;
			kr_caliber = "5.45x39";
	...
	class kr_Ammo_762x39_HP: Ammunition_Base
	{
		scope = 2;
		displayName = "$STR_kr_weapons_ammo_762x39_HP";
		descriptionShort = "$STR_kr_weapons_ammo_762x39_HP_dsc";
		model = "\KR\weapons\kr_weaponpack\ammunition\looseRounds\762x39_HP_LooseRounds.p3d";
		iconCartridge = 2;
		weight = 16;
		count = 60;
		ammo = "Bullet_762x39_HP";
		class kr_description
		{
			kr_tier = 3;
			kr_caliber = "7.62x39";
	...
	class kr_Ammo_9x39_HP: Ammunition_Base
	{
		scope = 2;
		displayName = "$STR_kr_weapons_ammo_9x39_HP";
		descriptionShort = "$STR_kr_weapons_ammo_9x39_HP_dsc";
		model = "\KR\weapons\kr_weaponpack\ammunition\looseRounds\9x39_HP_LooseRounds.p3d";
		iconCartridge = 2;
		weight = 23;
		count = 60;
		ammo = "Bullet_9x39_HP";
	...
	class kr_Ammo_127x55_PS12HP: Ammunition_Base
	{
		scope = 2;
		displayName = "$STR_kr_weapons_ammo_127x55_PS12HP";
		descriptionShort = "$STR_kr_weapons_ammo_127x55_PS12HP_dsc";
		model = "\KR\weapons\kr_weaponpack\ammunition\looseRounds\127x55_PS12HP_LooseRounds.p3d";
		hiddenSelections[] = {"camo"};
		hiddenSelectionsTextures[] = {"KR\weapons\kr_weaponpack\ammunition\data\PS12_HP_co.paa"};
		iconCartridge = 3;
		weight = 50;
		count = 60;
		ammo = "Bullet_127x55_PS12HP";
		class kr_description
		{
			kr_tier = 4;
			kr_caliber = "12.7x55";
