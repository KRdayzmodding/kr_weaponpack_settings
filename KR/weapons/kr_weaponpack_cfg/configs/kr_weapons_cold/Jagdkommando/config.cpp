////////////////////////////////////////////////////////////////////
//DeRap: kr_weapons_cold\Jagdkommando\config.bin
...
class CfgPatches
{
	class kr_weapons_cold_Jagdkommando
	{
...
class CfgVehicles
{
	...
	{
		scope = 2;
		displayName = "$STR_kr_weapons_cold_Jagdkommando";
		descriptionShort = "$STR_kr_weapons_cold_Jagdkommando_dsc";
		model = "\KR\weapons\kr_weaponpack\kr_weapons_cold\Jagdkommando\Jagdkommando.p3d";
		inventorySlot[] = {"Knife"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 150;
					healthLevels[] = {{1,{"KR\weapons\kr_weaponpack\kr_weapons_cold\Jagdkommando\data\Jagdkommando.rvmat"}},{0.6,{"KR\weapons\kr_weaponpack\kr_weapons_cold\Jagdkommando\data\Jagdkommando_worn.rvmat"}},{0.5,{"KR\weapons\kr_weaponpack\kr_weapons_cold\Jagdkommando\data\Jagdkommando_damage.rvmat"}},{0.3,{"KR\weapons\kr_weaponpack\kr_weapons_cold\Jagdkommando\data\Jagdkommando_badlydamage.rvmat"}},{0.01,{"KR\weapons\kr_weaponpack\kr_weapons_cold\Jagdkommando\data\Jagdkommando_destruct.rvmat"}}};
				};
			};
		};
		isMeleeWeapon = 1;
