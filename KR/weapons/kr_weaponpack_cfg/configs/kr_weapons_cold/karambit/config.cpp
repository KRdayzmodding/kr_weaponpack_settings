////////////////////////////////////////////////////////////////////
//DeRap: kr_weapons_cold\karambit\config.bin
...
class CfgPatches
{
	class kr_weapons_cold_karambit
	{
		units[] = {"kr_karambit"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	{
		scope = 2;
		displayName = "$STR_kr_weapons_cold_karambit";
		descriptionShort = "$STR_kr_weapons_cold_karambit_dsc";
		model = "\KR\weapons\kr_weaponpack\kr_weapons_cold\karambit\karambit.p3d";
		inventorySlot[] = {"Knife"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 150;
					healthLevels[] = {{1,{"KR\weapons\kr_weaponpack\kr_weapons_cold\karambit\data\karambit.rvmat"}},{0.6,{"KR\weapons\kr_weaponpack\kr_weapons_cold\karambit\data\karambit_worn.rvmat"}},{0.5,{"KR\weapons\kr_weaponpack\kr_weapons_cold\karambit\data\karambit_damage.rvmat"}},{0.3,{"KR\weapons\kr_weaponpack\kr_weapons_cold\karambit\data\karambit_badlydamage.rvmat"}},{0.01,{"KR\weapons\kr_weaponpack\kr_weapons_cold\karambit\data\karambit_destruct.rvmat"}}};
				};
			};
		};
		isMeleeWeapon = 1;
