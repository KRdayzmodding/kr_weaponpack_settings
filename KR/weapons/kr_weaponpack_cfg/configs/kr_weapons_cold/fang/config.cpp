////////////////////////////////////////////////////////////////////
//DeRap: kr_weapons_cold\fang\config.bin
...
class CfgVehicles
{
	...
	{
		scope = 2;
		displayName = "$STR_kr_weapons_cold_fang";
		descriptionShort = "$STR_kr_weapons_cold_fang_dsc";
		model = "\KR\weapons\kr_weaponpack\kr_weapons_cold\fang\fang.p3d";
		inventorySlot[] = {"Knife"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 200;
					healthLevels[] = {{1.0,{"KR\weapons\kr_weaponpack\kr_weapons_cold\fang\data\fang.rvmat"}},{0.7,{"KR\weapons\kr_weaponpack\kr_weapons_cold\fang\data\fang_worn.rvmat"}},{0.5,{"KR\weapons\kr_weaponpack\kr_weapons_cold\fang\data\fang_damage.rvmat"}},{0.3,{"KR\weapons\kr_weaponpack\kr_weapons_cold\fang\data\fang_badlydamage.rvmat"}},{0.0,{"KR\weapons\kr_weaponpack\kr_weapons_cold\fang\data\fang_destruct.rvmat"}}};
				};
			};
		};
		isMeleeWeapon = 1;
