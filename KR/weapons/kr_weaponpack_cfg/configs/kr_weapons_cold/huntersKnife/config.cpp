////////////////////////////////////////////////////////////////////
//DeRap: kr_weapons_cold\huntersKnife\config.bin
...
class CfgPatches
{
	class kr_weapons_cold_huntersKnife
	{
		units[] = {"kr_huntersKnife"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	{
		scope = 2;
		displayName = "$STR_kr_weapons_cold_huntersknife";
		descriptionShort = "$STR_kr_weapons_cold_huntersknife_dsc";
		model = "\KR\weapons\kr_weaponpack\kr_weapons_cold\huntersKnife\huntersKnife.p3d";
		inventorySlot[] = {"Knife"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 150;
					healthLevels[] = {{1,{"KR\weapons\kr_weaponpack\kr_weapons_cold\huntersKnife\data\huntersKnife.rvmat"}},{0.6,{"KR\weapons\kr_weaponpack\kr_weapons_cold\huntersKnife\data\huntersKnife_worn.rvmat"}},{0.5,{"KR\weapons\kr_weaponpack\kr_weapons_cold\huntersKnife\data\huntersKnife_damage.rvmat"}},{0.3,{"KR\weapons\kr_weaponpack\kr_weapons_cold\huntersKnife\data\huntersKnife_badlydamage.rvmat"}},{0.01,{"KR\weapons\kr_weaponpack\kr_weapons_cold\huntersKnife\data\huntersKnife_destruct.rvmat"}}};
				};
			};
		};
		isMeleeWeapon = 1;
