////////////////////////////////////////////////////////////////////
//DeRap: kr_weapons_cold\sawfishKnife\config.bin
...
class CfgPatches
{
	class kr_weapons_cold_sawfishKnife
	{
		units[] = {"kr_sawfishKnife"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	{
		scope = 2;
		displayName = "$STR_kr_weapons_cold_sawfishKnife";
		descriptionShort = "$STR_kr_weapons_cold_sawfishKnife_dsc";
		model = "\KR\weapons\kr_weaponpack\kr_weapons_cold\sawfishKnife\sawfishKnife.p3d";
		inventorySlot[] = {"Knife"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 200;
					healthLevels[] = {{1.0,{"KR\weapons\kr_weaponpack\kr_weapons_cold\sawfishKnife\data\sawfishKnife.rvmat"}},{0.7,{"KR\weapons\kr_weaponpack\kr_weapons_cold\sawfishKnife\data\sawfishKnife_worn.rvmat"}},{0.5,{"KR\weapons\kr_weaponpack\kr_weapons_cold\sawfishKnife\data\sawfishKnife_damage.rvmat"}},{0.3,{"KR\weapons\kr_weaponpack\kr_weapons_cold\sawfishKnife\data\sawfishKnife_badlydamage.rvmat"}},{0.0,{"KR\weapons\kr_weaponpack\kr_weapons_cold\sawfishKnife\data\sawfishKnife_destruct.rvmat"}}};
				};
			};
		};
		isMeleeWeapon = 1;
