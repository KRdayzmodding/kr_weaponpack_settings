////////////////////////////////////////////////////////////////////
//DeRap: kr_weapons_cold\kunai\config.bin
...
class CfgVehicles
{
	...
	{
		scope = 2;
		displayName = "$STR_kr_weapons_cold_kunai";
		descriptionShort = "$STR_kr_weapons_cold_kunai_dsc";
		model = "\KR\weapons\kr_weaponpack\kr_weapons_cold\kunai\kunai.p3d";
		inventorySlot[] = {"Knife"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 150;
					healthLevels[] = {{1,{"KR\weapons\kr_weaponpack\kr_weapons_cold\kunai\data\kunai.rvmat"}},{0.6,{"KR\weapons\kr_weaponpack\kr_weapons_cold\kunai\data\kunai_worn.rvmat"}},{0.5,{"KR\weapons\kr_weaponpack\kr_weapons_cold\kunai\data\kunai_damage.rvmat"}},{0.3,{"KR\weapons\kr_weaponpack\kr_weapons_cold\kunai\data\kunai_badlydamage.rvmat"}},{0.01,{"KR\weapons\kr_weaponpack\kr_weapons_cold\kunai\data\kunai_destruct.rvmat"}}};
				};
			};
		};
		isMeleeWeapon = 1;
