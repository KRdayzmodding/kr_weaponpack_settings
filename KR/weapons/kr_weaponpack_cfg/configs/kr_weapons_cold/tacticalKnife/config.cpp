////////////////////////////////////////////////////////////////////
//DeRap: kr_weapons_cold\tacticalKnife\config.bin
...
class CfgPatches
{
	class kr_weapons_cold_tacticalKnife
	{
		units[] = {"kr_tacticalKnife"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	{
		scope = 2;
		displayName = "$STR_kr_weapons_cold_tacticalKnife";
		descriptionShort = "$STR_kr_weapons_cold_tacticalKnife_dsc";
		model = "\KR\weapons\kr_weaponpack\kr_weapons_cold\tacticalKnife\tacticalKnife.p3d";
		inventorySlot[] = {"Knife"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 150;
					healthLevels[] = {{1,{"KR\weapons\kr_weaponpack\kr_weapons_cold\tacticalKnife\data\tacticalKnife.rvmat"}},{0.6,{"KR\weapons\kr_weaponpack\kr_weapons_cold\tacticalKnife\data\tacticalKnife_worn.rvmat"}},{0.5,{"KR\weapons\kr_weaponpack\kr_weapons_cold\tacticalKnife\data\tacticalKnife_damage.rvmat"}},{0.3,{"KR\weapons\kr_weaponpack\kr_weapons_cold\tacticalKnife\data\tacticalKnife_badlydamage.rvmat"}},{0.01,{"KR\weapons\kr_weaponpack\kr_weapons_cold\tacticalKnife\data\tacticalKnife_destruct.rvmat"}}};
				};
			};
		};
		isMeleeWeapon = 1;
