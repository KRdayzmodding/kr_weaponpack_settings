class CfgPatches
{
	class kr_weapons_firearms_m16a1
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
...
{
	class Rifle_Base;
	class kr_M16A1_Base: Rifle_Base
	{
		scope = 0;
		weight = 2276;
		absorbency = 0.0;
		...
		attachments[] = {"kr_muzzle556","kr_m16_hndgrd","kr_mount_m16","weaponOptics","kr_ar_pistolgrip","kr_ar_bttstck","weaponWrap"};
		WeaponLength = 0.856;
		barrelArmor = 7.5;
		...
		hiddenSelectionsTextures[] = {"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\m16a1\data\m16a1_co.paa"};
		hiddenSelectionsMaterials[] = {"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\m16a1\data\m16a1.rvmat"};
	...
	class kr_M16A1: kr_M16A1_Base
	{
		scope = 2;
		displayName = "$STR_weapons_firearms_M16A1";
		descriptionShort = "$STR_weapons_firearms_M16A1_dsc";
		model = "KR\weapons\kr_weaponpack_2\kr_weapons_firearms\m16a1\m16a1.p3d";
		itemSize[] = {8,3};
		weight = 3100;
		WeaponLength = 0.845;
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 300;
					healthLevels[] = {{1.0,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\m16a1\data\m16a1.rvmat"}},{0.7,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\m16a1\data\m16a1_worn.rvmat"}},{0.5,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\m16a1\data\m16a1_damage.rvmat"}},{0.3,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\m16a1\data\m16a1_badlydamage.rvmat"}},{0.0,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\m16a1\data\m16a1_destruct.rvmat"}}};
				};
			};
		};
