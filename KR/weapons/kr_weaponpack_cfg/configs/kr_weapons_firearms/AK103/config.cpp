...
class cfgWeapons
{
	...
	class kr_ak103_Base: kr_ak_Base
	{
		...
		attachments[] = {"kr_muzzle762_39","kr_ak_hndgrd","weaponOpticsAK","kr_ak_receiver","kr_ak_pistolgrip","kr_ak_fstock","weaponHolo1","weaponHolo2","weaponHolo3","weaponHolo4","weaponHolo5","weaponOptics","weaponOptics1","weaponOpticsDT","kr_ak_handle","weaponWrap","kr_proxyParts"};
		weight = 2600;
		WeaponLength = 0.66;
		itemSize[] = {8,3};
