class CfgPatches
{
	class kr_weapons_firearms_ak74m
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
...
{
	class kr_ak_Base;
	class kr_ak74m_Base: kr_ak_Base
	{
		scope = 0;
		model = "\KR\weapons\kr_weaponpack_2\kr_weapons_firearms\ak74m\ak74m.p3d";
		weight = 2700;
		WeaponLength = 0.7;
		itemSize[] = {8,3};
		...
		barrelArmor = 8.4;
		recoilModifier[] = {1.2,1.2,1.25};
		swayModifier[] = {1.7,1.5,1.15};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 350;
					healthLevels[] = {{1.0,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\ak74m\data\ak74m.rvmat"}},{0.7,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\ak74m\data\ak74m_worn.rvmat"}},{0.5,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\ak74m\data\ak74m_damage.rvmat"}},{0.3,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\ak74m\data\ak74m_badlydamage.rvmat"}},{0.0,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\ak74m\data\ak74m_destruct.rvmat"}}};
				};
			};
		};
		class NoiseShoot
