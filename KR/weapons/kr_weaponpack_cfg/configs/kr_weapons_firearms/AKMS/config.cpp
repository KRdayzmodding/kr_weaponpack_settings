class CfgPatches
{
	class kr_weapons_firearms_akms
	{
		units[] = {};
		weapons[] = {"kr_akmsn","kr_akms"};
		requiredVersion = 0.1;
...
{
	class kr_ak_Base;
	class kr_akms_Base: kr_ak_Base
	{
		scope = 0;
		model = "\KR\weapons\kr_weaponpack_2\kr_weapons_firearms\akms\akms.p3d";
		itemSize[] = {8,3};
		weight = 2700;
		WeaponLength = 0.7;
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 350;
					healthLevels[] = {{1.0,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\akms\data\akms.rvmat"}},{0.7,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\akms\data\akms_worn.rvmat"}},{0.5,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\akms\data\akms_damage.rvmat"}},{0.3,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\akms\data\akms_badlydamage.rvmat"}},{0.0,{"KR\weapons\kr_weaponpack_2\kr_weapons_firearms\akms\data\akms_destruct.rvmat"}}};
				};
			};
		};
	...
	class kr_akmsn: kr_akms_Base
	{
		scope = 2;
		displayName = "$STR_weapons_firearms_akmsn";
	...
	{
		scope = 2;
		displayName = "$STR_weapons_firearms_akms";
		descriptionShort = "$STR_weapons_firearms_akms_dsc";
		class kr_description
		{
			kr_tier = 2;
			kr_caliber = "7.62x39";
