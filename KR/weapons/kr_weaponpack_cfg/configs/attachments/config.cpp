class CfgPatches
{
	class kr_weaponpack_attachments
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgNonAIVehicles
{
	...
	class ProxyMag_762x51_kac_steel_10Rnd: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "magazine";
	...
	class Proxyak_handguard_alfa_arms_goliaf: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "kr_aks74u_hndgrd";
		model = "\KR\weapons\kr_weaponpack\attachments\support\ak_handguards\ak_handguard_alfa_arms_goliaf.p3d";
	};
	class Proxyak_handguard_xrsu47su: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "kr_aks74u_hndgrd";
	...
	class Proxysaiga12k_handguard_saiga12k_std: ProxyAttachment
	{
		scope = 2;
	...
	class Proxymuzzle762_54_adapter_762_39_wt1052: ProxyAttachment
	{
		scope = 2;
	...
	class Proxybipod_atlas_v8_bt10: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "kr_bipod";
		model = "\KR\weapons\kr_weaponpack\attachments\support\bipods\bipod_atlas_v8_bt10.p3d";
	};
	class ProxyMag_9x18_apb_20Rnd: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "magazine";
		model = "KR\weapons\kr_weaponpack_2\attachments\magazine\9x18\Mag_9x18_apb_20Rnd.p3d";
	};
	class ProxyMag_9x18_pm_8Rnd: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "magazine";
		model = "KR\weapons\kr_weaponpack_2\attachments\magazine\9x18\Mag_9x18_pm_8Rnd.p3d";
	};
	class ProxyMag_9x18_pm_84Rnd: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "magazine";
		model = "KR\weapons\kr_weaponpack_2\attachments\magazine\9x18\Mag_9x18_pm_84Rnd.p3d";
	};
	class Proxypgrip_tt_PM_laser: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "kr_tt_grip";
		model = "\KR\weapons\kr_weaponpack_2\attachments\support\tt_grips\pgrip_tt_PM_laser.p3d";
	};
	class Proxypgrip_tt_rubberized: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "kr_tt_grip";
		model = "\KR\weapons\kr_weaponpack_2\attachments\support\tt_grips\pgrip_tt_rubberized.p3d";
	};
	class Proxypgrip_tt_razor_arms: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "kr_tt_grip";
		model = "\KR\weapons\kr_weaponpack_2\attachments\support\tt_grips\pgrip_tt_razor_arms.p3d";
	};
	class Proxylaser_tt_dlp_tactical_precision: ProxyAttachment
	{
		scope = 2;
		inventorySlot = "kr_tt_laser";
