class CfgPatches
{
	...
	{
		units[] = {"kr_holosight_aimpoint_pro","kr_holosight_aksion_ekp_8","kr_holosight_belomo_pk06","kr_holosight_eotech_xps3","kr_holosight_es_hco","kr_holosight_holosun_aems","kr_holosight_holosun_aems_v2","kr_holosight_monstrum_compact","kr_holosight_OKP_7","kr_holosight_valday_1p87","kr_holosight_valday_krechet","kr_holosight_vortex_razor_amg_uh1","kr_scope_sig_bravo4","kr_scope_acog_ta01nsn","kr_scope_acog_ta11","kr_scope_leupold_mark4_hamr","kr_scope_elcan_specter_dr4","kr_scope_valday_ps320","kr_optics_sb_pm2","kr_optics_vomz_pilad","kr_optics_burris_fullfield_tac30"};
		weapons[] = {};
		requiredVersion = 0.1;
